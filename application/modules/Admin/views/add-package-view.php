	...
	<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
		...
		<?php } ?>	
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="package_name" value="<?php echo $this->input->post('package_name');?>" placeholder="Enter Restaurant Name" />
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="cost_package" value="<?php echo $this->input->post('cost_package');?>" placeholder="Enter Restaurant Address" />
