									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item" href="<?php echo base_url();?>admin/edit-banner/<?php echo  $row['id'];?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="<?php echo base_url();?>admin/Bannerslider/delete/<?php echo  $row['id'];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
