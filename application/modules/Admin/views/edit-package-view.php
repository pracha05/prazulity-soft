...
<div class="main-container">
	<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
		...
		<?php } ?>	
						<legend class="scheduler-border">Package Information</legend>
					
					<div class="row">
					<div class="form-group col-md-6">
						<label class="">Package Name</label>
						<div class="">
							<input type="text" class="form-control" name="package_name" value="<?php echo $record['package_name'];?>" placeholder="Enter Restaurant Name" />
							<b><?php echo form_error('package_name'); ?></b>
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="">Price</label>
						<div class="">
							<input type="text" class="form-control" name="cost_package" value="<?php echo $record['cost_package'];?>" placeholder="Enter Restaurant Address" />
							<b><?php echo form_error('cost_package'); ?></b>
						</div>
					</div>
					<div class="form-group col-md-6">
						...
						<div class="">
							<select class="form-control" name="billing">
								...
								<option value="1" <?php if($record['billing'] == 1){ ?>selected<?php } ?>>Half Yearly</option>
								<option value="2" <?php if($record['billing'] ==2){ ?>selected<?php } ?>>Yearly</option>
							</select>
						</div>
					</div>
