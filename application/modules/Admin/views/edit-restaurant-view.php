	...
	<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
		...
		<?php } ?>	
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="name" value="<?php echo $record['name'];?>" placeholder="Enter Restaurant Name" />
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="mobile" value="<?php echo $record['mob_num'];?>" placeholder="Enter Restaurant Address" />
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="email" value="<?php echo $record['email'];?>" placeholder="Restaurant Mobile Number" />
