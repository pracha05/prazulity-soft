...
<?php echo $this->load->view('../views/kitchen/head.php'); ?>
  <?php echo $this->load->view('../views/kitchen/header.php',$sess_data); ?>
	<?php echo $this->load->view('../views/kitchen/sidebar.php'); ?>
...
<div class="main-container">
	<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
		...
		<?php echo $this->load->view('../views/kitchen/footer.php'); ?>
		<?php //include( "footer.php"); ?>
	</div>
</div>
	<?php echo $this->load->view('../views/kitchen/script.php'); ?>
