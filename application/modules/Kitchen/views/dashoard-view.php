...
<?php $this->load->view('../views/kitchen/sidebar.php'); ?>
	...
	<script src="<?php echo base_url();?>/asserts/src/plugins/highcharts-6.0.7/code/highcharts.js"></script>
	<script src="<?php echo base_url();?>/asserts/src/plugins/highcharts-6.0.7/code/highcharts-more.js"></script>
