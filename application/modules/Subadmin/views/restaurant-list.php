									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item" href="<?php echo base_url();?>sub-admin/edit-restarent/<?php echo  $row['id'];?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" onclick="return confirm('Are you sure you want to Remove?');" href="<?php echo base_url();?>Subadmin/Restaurant/delete/<?php echo  $row['id'];?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
