	...
	<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
		...
		<?php } ?>
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" value="<?php echo $record['offer_type'];?>" name="offer_type" placeholder="Enter Offer type" />
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" value="<?php echo $record['item'];?>" name="item" placeholder="Enter Item" /><b><?php echo form_error('item'); ?></b>
						</div>
					</div>	
					<div class="form-group col-md-6">
						<label class="">Offer description</label>
						<div class="">
							<textarea class="form-control" value="<?php echo $record['ofer_des'];?>" name="offer_des"><?php echo $record['ofer_des'];?></textarea>
					...
					<div class="form-group col-md-6">
						<div class="col-lg-9 col-lg-offset-3">
							<button type="submit" class="btn btn-primary" name="submit" value="add">Update</button>
						</div>
					</div>
				</div>
				</fieldset>
