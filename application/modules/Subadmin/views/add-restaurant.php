			...
			<form method="post">
				 <fieldset class="scheduler-border">
					...
					<!--<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="reg_num" placeholder="Enter Register Number" />
						</div>
					</div>-->
					<div class="form-group col-md-6">
						<label class="">Restaurant Name</label>
						<div class="">
							<input type="text" class="form-control" name="reg_name" placeholder="Enter Restaurant Name" /><b><?php echo form_error('reg_name'); ?></b>
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="">Restaurant Mobile</label>
						<div class="">
							<input type="text" class="form-control" name="mobile" placeholder="Enter Mobile Number" /><b><?php echo form_error('mobile'); ?></b>
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="">Email</label>
						<div class="">
							<input type="text" class="form-control" name="email" placeholder="Enter Email Address" /><b><?php echo form_error('email'); ?></b>
						</div>
					</div>	
					<div class="form-group col-md-6">
						<label class="">Address</label>
						<div class="">
							<textarea class="form-control" cols="1" name="address"></textarea>
