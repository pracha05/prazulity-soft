			...
			<form method="post">
				 <fieldset class="scheduler-border">
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" value="<?php echo $record['holder_name'];?>" name="holder_name" placeholder="Enter Bank Account Details" /><b><?php echo form_error('holder_name'); ?></b>
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="">Bank Account Number</label>
						<div class="">
							<input type="text" class="form-control" value="<?php echo $record['account_num'];?>"  name="act_num" placeholder="Enter Bank Account Number" />
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control"  value="<?php echo $record['ifsc_code'];?>" name="ifc_code" placeholder="Enter IFSC Code" /><b><?php echo form_error('ifc_code'); ?></b>
						</div>
					</div>
